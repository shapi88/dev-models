...
| Require status checks to pass | ✅ Enabled | guardrails-check, scope-control, secret-scan |
...
This document follows the gh600-exam standard for auditable, reproducible branch protection.