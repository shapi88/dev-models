...
2. Read `.github/copilot-instructions.md` or `.grok/grok-instructions.md` — which stop condition was not triggered?
...
| --- | --- |
| Agent did not stop when it should | Add stop condition to `.github/copilot-instructions.md` or `.grok/grok-instructions.md` |
...
| SOLID or Clean Architecture violation | Strengthen Reviewer agent prompt + add to guardrails hard stops |
...
- `.grok/guardrails.md` and `.grok/grok-instructions.md` — local mirrors

This runbook follows the gh600-exam standard and is suitable for any project using this agent system.