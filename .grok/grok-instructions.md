...
- When editing or generating locally, maintain consistency with the Spring Boot 4 reference module.
...
This is the local counterpart to .github/copilot-instructions.md. Use together with .grok/guardrails.md and agent definitions.